...
const MovieCard = ({movieCard,rate}) => {
  ...
  return (
    <div style={{ margin: "50px", paddingTop: "20px" , textALign : "center" }}>
      <Card style={{ width: "18rem" ,borderStyle:'outset' , textALign : "center" , boxShadow :' 1px 2px 5px 1px rgb(100, 100, 100)' }}>
        <Card.Img variant="top" src={movieCard.posterUrl}  style={{ height: "350px", width:'286px', borderRadius : "5px", boxShadow :'3px 3px 6px 3px rgb(100, 100, 100)' }} />
